%!TEX root = /Users/rvasa/papers/thesis/thesis.tex
...
\newcommand{\subsecref}[1]{Section~\ref{sub:#1}}
\newcommand{\subsubsecref}[1]{Section~\ref{ssub:#1}}
\newcommand{\figref}[1]{Figure~\ref{fig:#1}}
\newcommand{\chapref}[1]{Chapter~\ref{cha:#1}}
\newcommand{\appendixref}[1]{Appendix~\ref{cha:#1}}
